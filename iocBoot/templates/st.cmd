...
$$ENDIF(Y_MOT)
$$ENDLOOP(LENS)
dbLoadRecords("db/beam.db", "LOCATION=$$LOCATION,HIGH_LIMIT=$$BEAMHIGH_LIMIT0,LOW_LIMIT=$$BEAMLOW_LIMIT0,FOCUS=$$LOCATION:LENS:$$CALC{$$COUNT(LENS),%02d}:IMAGE,SOURCE_Z=$$BEAMSOURCE0,SOURCE_MAG=$$IF(BEAMSOURCE_MAG0,$$BEAMSOURCE_MAG0 CPP,1),NLENS=$$COUNT(LENS)")
$$LOOP(STACK)
$$IF(NLENS,3)
