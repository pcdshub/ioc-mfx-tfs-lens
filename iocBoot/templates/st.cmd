...
dbLoadRecords("db/lens.db", "LOCATION=$$LOCATION,LENSID=$$LENSID,RADIUS=$$RADIUS,Z=$$Z,Z_MOT=$$IF(Z_MOT,$$Z_MOT CPP,0),PREV_Z=$$LOCATION:LENS:BEAM:SOURCE,PREV_CRL=0.0,Y_MOT=$$Y_MOT,IN_STATE=$$IN_STATE,PREV_MAG=$$LOCATION:LENS:BEAM:SIZE,SAFEBIT=$$IF(SAFEBIT,$$SAFEBIT,0.0),INBIT=$$IF(INBIT,$$INBIT,0.0)")
$$ENDIF(PREV_LENS)
$$ENDLOOP(LENS)
