...
#Load Lenses
#####################
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:01,Y_MOT=MFX:TFS:XFLS:01,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:02,Y_MOT=MFX:TFS:XFLS:02,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:03,Y_MOT=MFX:TFS:XFLS:03,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:04,Y_MOT=MFX:TFS:XFLS:04,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:05,Y_MOT=MFX:TFS:XFLS:05,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:06,Y_MOT=MFX:TFS:XFLS:06,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:07,Y_MOT=MFX:TFS:XFLS:07,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:08,Y_MOT=MFX:TFS:XFLS:08,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:09,Y_MOT=MFX:TFS:XFLS:09,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
dbLoadRecords("db/lens.db", "LOCATION=$(LOCATION),LENSID=TFS:10,Y_MOT=MFX:TFS:XFLS:10,Z_MOT=MFX:TFS:MMS:21,IN_STATE=IN")
